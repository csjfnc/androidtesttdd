...
public class ListaLeilaoAdapter extends RecyclerView.Adapter<ListaLeilaoAdapter.ViewHolder> {
    ...
    private FormatadorDeMoeda formatadorDeMoeda;

    public ListaLeilaoAdapter(Context context, List<Leilao> leiloes) {
        this.context = context;
        this.leiloes = leiloes;
        formatadorDeMoeda = new FormatadorDeMoeda();
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private final TextView textViewMaiorLance;
        private Leilao leilao;

        ViewHolder(View itemView) {
            super(itemView);
            descricao = itemView.findViewById(R.id.item_leilao_descricao);
            textViewMaiorLance = itemView.findViewById(R.id.item_leilao_maior_lance);
        ...
        void vincula(Leilao leilao) {
            ...
            textViewMaiorLance.setText(String.valueOf(formatadorDeMoeda.formata(leilao.getMaiorLance())));
        }
